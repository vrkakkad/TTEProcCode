...
if options.dataflow.ARFI
    ...
    [arfidata.traced_gate,trace_flag] = dispARFI(ecgdata,bdata,arfidata,arfidata_mf_pre,arfidata_mf_push,options,arfi_par);
end
...
elseif (~strcmpi(trace_flag,'n') && ~isempty(arfidata.traced_gate))
    options.dataflow.saveRes = 1;
