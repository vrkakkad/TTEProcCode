function [out1,out2,out3] = ginput_alt(arg1,arg2)
...
if ~matlab.ui.internal.isFigureShowEnabled
    ...
    initialState = setupFcn(fig,arg2);
...
function initialState = setupFcn(fig,arg2)
...
initialState.CrossHair = createCrossHair(fig,arg2);
...
function crossHair = createCrossHair(fig,arg2)
% Create annotations to simulate fullcrosshair pointer.
gap = getGap(fig);
crossHair(1) = annotation(fig, 'line', [0 .5-gap(1)], [.5 .5],'LineStyle','--'); % horizontal left
crossHair(2) = annotation(fig, 'line', [.5+gap(1) 1], [.5 .5],'LineStyle','--'); % horizontal right
crossHair(3) = annotation(fig, 'line', [.5 .5], [0 .5-gap(2)],'LineStyle','--'); % vertical bottom
crossHair(4) = annotation(fig, 'line', [.5 .5], [0.5+gap(2) 1],'LineStyle','--'); % vertical top
set(crossHair, 'LineWidth', 1,'Color',arg2,'Visible','off', 'HandleVisibility', 'off', 'HitTest', 'off', 'PickableParts','none');
end
